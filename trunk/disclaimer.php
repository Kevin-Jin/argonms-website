...
function loginPrompt() {
	return
<<<EOD
<form action="index.php?action=login&back={$_SERVER['PHP_SELF']}" method="post">
<div>
...
<br />
<a href="forum">Enter the forums for help, news, and discussion</a>
</div>
</form>
EOD;
}
