...
<p>Oh, and Lloyd Korn, in response to your "if you put lipstick on a pig, it's still a pig" comment: we liken it more to reconstructing a dinosaur using only fossils and hints from its modern day relatives than dressing up a pig. That is what it's like to emulate the earlier versions of MapleStory so faithfully without being able to play it today. Why are we being targeted for litigation when we should be applauded for our efforts - for being so determined to restore a version of MapleStory that Nexon probably does not even have any backups of?</p>
<br />
